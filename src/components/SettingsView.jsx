    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="card mb-4">
        ...
        <div className="rounded-2xl p-4 mb-4" style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.08)'}}>
          <p className="text-sm font-semibold text-white mb-1">⚙️ Sistemski yt-dlp</p>
          <p className="text-xs mb-3" style={{color:'rgba(255,255,255,0.4)'}}>
            Koristi yt-dlp instaliran na sistemu umjesto bundlovanog — uvijek najnovija verzija
          </p>
          <label className="flex items-center gap-2 cursor-pointer">
            <div onClick={()=>updateSettings({useSystemYtdlp:!settings?.useSystemYtdlp})}
              className="relative w-10 h-6 rounded-full transition-all"
              style={{background:settings?.useSystemYtdlp?'#7c3aed':'rgba(255,255,255,0.15)'}}>
              <div className="absolute top-1 w-4 h-4 rounded-full bg-white transition-all"
                style={{left:settings?.useSystemYtdlp?'22px':'4px'}}/>
            </div>
            <span className="text-sm" style={{color:'rgba(255,255,255,0.7)'}}>Koristi sistemski yt-dlp</span>
          </label>
          {settings?.useSystemYtdlp && (
            <p className="text-xs mt-2" style={{color:'#4ade80'}}>
              ✓ Program će koristiti yt-dlp sa sistema — restart programa potreban
            </p>
          )}
        </div>
